...
1. O que acontece se você remover o `.tabset` das opções da segunda linha.

2. Acrescente mais uma aba à segunda linha, replicando os gráficos para algum outro tipo.
